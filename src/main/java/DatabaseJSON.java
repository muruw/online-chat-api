...
public class DatabaseJSON {
    ...
    public void addSentMessage(long userId, long receiverId, String message, String time, JSONObject databaseJSON, JSONArray usersJSON, JSONArray orderJSON) throws Exception {
